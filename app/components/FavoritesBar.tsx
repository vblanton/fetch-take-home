  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center p-2 sm:p-4">
      <div className="bg-purple-900 text-white rounded-full px-3 sm:px-6 py-2 sm:py-3 shadow-lg flex items-center gap-2 sm:gap-4">
        ...
        <div className="h-4 sm:h-6 w-px bg-purple-700 mx-1 sm:mx-2"></div>
        ...
        {error && (
          <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-red-500 text-white px-3 sm:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm">
            {error}
          </div>
        )}
      </div>
